  ...
  output <- tryCatch(
    {
      ...
      run_number <- create_new_run_number(param_json)
      all_cache_paths <- load_cache_paths(football_data_cache,
      ...
      output <- run_prediction(all_cache_paths, local_input, settings, run_number)
