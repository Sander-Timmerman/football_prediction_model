run_prediction <- function(all_cache_paths, local_input, settings, run_number) {
  
  input_data_past_seasons <- load_input_data(all_cache_paths$football_data_cache, 
                                             all_cache_paths$aggregated_football_data_cache, 
                                             all_cache_paths$transfermarkt_data_cache, 
                                             all_cache_paths$player_jsons_cache,
  ...
  input_data_this_season <- load_input_data(football_data_cache = NULL, 
                                            ...
                                            transfermarkt_data_cache = all_cache_paths$transfermarkt_data_new_cache, 
                                            player_jsons_cache = NULL,
                                            all_cache_paths$all_final_standings_cache,
                                            local_input,
  ...
  results_table <- do_monte_carlo_simulation(prediction, football_data_new, namen, settings)
